    ...
    <div class="row justify-content-center">
      <div class=" pt-5 col-12 ">
        <form @submit.prevent=searchingProducts(filter) class="d-flex justify-content-end pr-5">
          <input v-model="filter" @keyup=searchingProducts(filter) type="text" placeholder="  Buscar..." class="text-center border-secondary rounded-pill " ><a  class=" fas fa-search m-2"/>
        </form>
      </div>
      <div id="active"
...
#active:hover{ box-shadow: 2px 2px 2px 2px #999; }
